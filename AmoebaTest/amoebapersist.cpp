...
void AmoebaPersist::save(int n, int m, int nextPlayer, QVector<QVector<int> > board){
    QFile f("amoeba.save");
...
bool AmoebaPersist::load(int &n, int &m, int &nextPlayer, QVector<QVector<int> > &board){
    QFile f("save.save");
